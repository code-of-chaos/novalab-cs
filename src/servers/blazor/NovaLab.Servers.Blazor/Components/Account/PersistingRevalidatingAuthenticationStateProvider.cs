...
using NovaLab.WasmClient;
using System.Diagnostics;
using System.Security.Claims;

namespace NovaLab.Servers.Blazor.Components.Account;
...
internal sealed class PersistingRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider {
    ...
    private async Task<bool> ValidateSecurityStampAsync(UserManager<NovaLabUser> userManager, ClaimsPrincipal principal) {
