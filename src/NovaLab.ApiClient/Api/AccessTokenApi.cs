...
namespace NovaLab.ApiClient.Api
{
    ...
    public interface IAccessTokenApiSync : IApiAccessor
    {
        ...
        ApiResult RefreshTokens(string? userId = default(string?), int operationIndex = 0);
        ...
        ApiResponse<ApiResult> RefreshTokensWithHttpInfo(string? userId = default(string?), int operationIndex = 0);
    ...
    public interface IAccessTokenApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResult> RefreshTokensAsync(string? userId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ApiResult>> RefreshTokensWithHttpInfoAsync(string? userId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AccessTokenApi : IAccessTokenApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResult</returns>
        public ApiResult RefreshTokens(string? userId = default(string?), int operationIndex = 0)
        {
            NovaLab.ApiClient.Client.ApiResponse<ApiResult> localVarResponse = RefreshTokensWithHttpInfo(userId);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ApiResult</returns>
        public NovaLab.ApiClient.Client.ApiResponse<ApiResult> RefreshTokensWithHttpInfo(string? userId = default(string?), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<ApiResult>("/api/twitch/tokens/refresh", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResult</returns>
        public async System.Threading.Tasks.Task<ApiResult> RefreshTokensAsync(string? userId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            NovaLab.ApiClient.Client.ApiResponse<ApiResult> localVarResponse = await RefreshTokensWithHttpInfoAsync(userId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ApiResult)</returns>
        public async System.Threading.Tasks.Task<NovaLab.ApiClient.Client.ApiResponse<ApiResult>> RefreshTokensWithHttpInfoAsync(string? userId = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ApiResult>("/api/twitch/tokens/refresh", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
