...
public class TwitchManagedRewardStringValueTupleApiResult : IEquatable<TwitchManagedRewardStringValueTupleApiResult>, IValidatableObject {
    /// <summary>
    ...
    public TwitchManagedRewardStringValueTupleApiResult(HttpStatusCode? status = default, string message = default, List<object> data = default) {
        Status = status;
        Message = message;
        Data = data;
    }
    ...
    /// <returns>Boolean</returns>
    public override bool Equals(object input) => Equals(input as TwitchManagedRewardStringValueTupleApiResult);
