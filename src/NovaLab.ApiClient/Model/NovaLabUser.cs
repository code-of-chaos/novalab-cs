...
public class NovaLabUser : IEquatable<NovaLabUser>, IValidatableObject {
    /// <summary>
    ...
    public NovaLabUser(string id = default, string userName = default, string normalizedUserName = default, string email = default, string normalizedEmail = default, bool emailConfirmed = default, string passwordHash = default, string securityStamp = default, string concurrencyStamp = default, string phoneNumber = default, bool phoneNumberConfirmed = default, bool twoFactorEnabled = default, DateTime? lockoutEnd = default, bool lockoutEnabled = default, int accessFailedCount = default, string twitchBroadcasterId = default, TwitchFollowerGoal twitchFollowerGoal = default) {
        ...
        TwitchFollowerGoal = twitchFollowerGoal;
    }
    ...
    /// <summary>
    ///     Gets or Sets TwitchFollowerGoal
    /// </summary>
    [DataMember(Name = "twitchFollowerGoal", EmitDefaultValue = false)]
    public TwitchFollowerGoal TwitchFollowerGoal { get; set; }
    ...
    public bool Equals(NovaLabUser input) {
        ...
        return
            ...
            (
                TwitchFollowerGoal == input.TwitchFollowerGoal ||
                TwitchFollowerGoal != null &&
                TwitchFollowerGoal.Equals(input.TwitchFollowerGoal)
            );
    }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext) {
        ...
        if (TwitchBroadcasterId != null && TwitchBroadcasterId.Length > 16) {
            yield return new ValidationResult("Invalid value for TwitchBroadcasterId, length must be less than 16.", new[] { "TwitchBroadcasterId" });
        }
    ...
    public override string ToString() {
        ...
        sb.Append("  TwitchFollowerGoal: ").Append(TwitchFollowerGoal).Append("\n");
        sb.Append("}\n");
        return sb.ToString();
    }
    ...
    /// <returns>Boolean</returns>
    public override bool Equals(object input) => Equals(input as NovaLabUser);
    ...
    public override int GetHashCode() {
        unchecked// Overflow is fine, just wrap
        {
            ...
            if (TwitchFollowerGoal != null) {
                hashCode = hashCode * 59 + TwitchFollowerGoal.GetHashCode();
            }
            return hashCode;
        }
    }
