...
namespace NovaLab.Server.Database.Migrations
{
    ...
    [Migration("20240610125901_TwitchBroadcasterId")]
    partial class TwitchBroadcasterId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaLab.Server.Database.Models.Twitch.HelixApi.TwitchGameTitleToIdCache", b =>
                {
            ...
            modelBuilder.Entity("NovaLab.Server.Database.Models.Twitch.TrackedStreamSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaLab.Server.Database.Models.Twitch.TrackedStreamSubjectComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaLab.Server.Database.Models.Twitch.TrackedStreamSubjectComponent", b =>
                {
                    b.HasOne("NovaLab.Server.Database.Models.Twitch.TrackedStreamSubject", "TrackedStreamSubject")
                        .WithOne("TrackedStreamSubjectComponent")
                        .HasForeignKey("NovaLab.Server.Database.Models.Twitch.TrackedStreamSubjectComponent", "Id");
