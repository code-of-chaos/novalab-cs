...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Account.NovaLabUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Twitch.HelixApi.TwitchGameTitleToIdCache", b =>
                {
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Twitch.TrackedStreamSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Twitch.TrackedStreamSubjectComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("NovaLab.Database.Models.Account.NovaLabUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Twitch.TrackedStreamSubject", b =>
                {
                    b.HasOne("NovaLab.Database.Models.Account.NovaLabUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NovaLab.Database.Models.Twitch.TrackedStreamSubjectComponent", b =>
                {
                    b.HasOne("NovaLab.Database.Models.Twitch.TrackedStreamSubject", "TrackedStreamSubject")
                        .WithOne("TrackedStreamSubjectComponent")
                        .HasForeignKey("NovaLab.Database.Models.Twitch.TrackedStreamSubjectComponent", "Id");
