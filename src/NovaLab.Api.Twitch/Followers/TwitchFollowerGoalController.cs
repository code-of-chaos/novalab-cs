...
public class TwitchFollowerGoalController(
    ...
    // -----------------------------------------------------------------------------------------------------------------
    [HttpGet]
    [ProducesResponseType<ApiResult<TwitchFollowerGoalDto>>((int)HttpStatusCode.OK)]
    ...
    public async Task<IActionResult> GetFollowerGoals(
        ...
        try {
            ...
            return Success(result
                .Select(TwitchFollowerGoalDto.FromDbObject)
            );
        }
        catch (Exception ex) {
    ...
    public async Task<IActionResult> PostFollowerGoal(
        ...
        try {
            ...
            return Success(TwitchFollowerGoalDto.FromDbObject(followerGoal));
