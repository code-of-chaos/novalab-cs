...
namespace NovaLab.Data.Migrations
{
    ...
    [Migration("20240601175710_TMSSfix")]
    partial class TMSSfix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NovaLab.Data.Data.Twitch.Streams.TwitchManagedStreamSubject", b =>
                {
                    ...
                    b.Property<string>("ObsSubjectTitle")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("varchar(128)");
                    ...
                    b.Property<string>("TwitchSubjectTitle")
                        .IsRequired()
                        .HasMaxLength(140)
            ...
            modelBuilder.Entity("NovaLab.Data.NovaLabUser", b =>
                {
                    ...
                    b.Property<Guid?>("SelectedManagedStreamSubjectId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("SelectedManagedStreamSubjectId")
                        .IsUnique();
